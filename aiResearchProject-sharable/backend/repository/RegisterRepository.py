...
class RegisterRepository:
    def create_account(self, first_name, email, username, password, role):
        ...
        cur.execute("""
                       INSERT INTO users (user_id,first_name, email, username, password, role)
                       VALUES (?, ?, ?, ?, ?, ?)
                       """, (user_id,first_name, email, username, password, role))
        con.commit()
        con.close()
