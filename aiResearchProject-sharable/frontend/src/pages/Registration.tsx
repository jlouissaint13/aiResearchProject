...
const Registration = () => {
    ...
    const [adminKey, setAdminKey] = useState<string>(''); // admin signup key
    ...
    async function registration() {
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                alert("Admin registration pending approval by an existing admin.");
                navigate('/Login');
            }
            else if (response.status === 403) {
                alert("Invalid admin password. Please enter the correct key.");
            }
        ...
        >
            ...
            >
                ...
                <FormControl fullWidth variant="outlined" sx={{ mt: 2 }}>
                    <InputLabel id="role-label" sx={{ color: '#8e8e8e', '&.Mui-focused': { color: '#1a73e8' } }}>
                        Sign Up As
                    </InputLabel>
                    <Select
                        labelId="role-label"
